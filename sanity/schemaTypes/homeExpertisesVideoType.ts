...
/**
 * Vidéo de fond de la section « Nos expertises » de la page d'accueil
 ...
 */
export const homeExpertisesVideoType = defineType({
  name: 'homeExpertisesVideo',
  ...
  fields: [
    defineField({
      ...
      type: 'boolean',
      description:
        'Si désactivée (ou sans vidéo), la section conserve son fond bleu dégradé d’origine.',
      initialValue: false,
    }),
    defineField({
      name: 'video',
